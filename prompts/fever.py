standard_prompt = '''Task:  Answer the given question and determine if there is Observation that SUPPORTS or REFUTES a Claim, or if there is NOT ENOUGH INFO, and conclude with the phrase 'so the final answer is: [SUPPORTS or REFUTES or NOT ENOUGH INFO]. End of answer.
Claim: Reg Watson is a current television producer. Answer:  so the final answer is: REFUTES. End of answer.
Claim: The Gadsden flag was named by Christopher Gadsden. Answer:  so the final answer is: NOT ENOUGH INFO. End of answer.
Claim: Black Mirror is about society. Answer:  so the final answer is: SUPPORTS. End of answer.
Claim: {input}
'''



cot_prompt = '''Task:  Answer the given question step-by-step. Determine if there is Observation that SUPPORTS or REFUTES a Claim, or if there is NOT ENOUGH INFO, and conclude with the phrase 'so the final answer is: [SUPPORTS or REFUTES or NOT ENOUGH INFO]. End of answer.
Claim: Reg Watson is a current television producer. Answer: Step 1, who is Reg Watson? Reginald James Watson AM was an Australian television producer and screenwriter. Step 2, when did  Reginald James Watson AM die? Reginald James Watson AM died on 8 October 2019. Step 3, so the final answer is: REFUTES. End of answer.
Claim: The Gadsden flag was named by Christopher Gadsden. Answer: Step 1, what is the origin of the name of the Gadsden flag? The Gadsden flag is named after politician Christopher Gadsden. Step 2,who named the Gadsden flag? there is no information on who named the Gadsden flag. Step 3, so the final answer is: NOT ENOUGH INFO. End of answer.
Claim: Black Mirror is about society. Answer: Step 1, what is the son of Black Mirror? Black Mirror is a British anthology television series. Step 2, what issues does this series discuss? The series uses technology to comment on contemporary social issues. Step 3, so the final answer is: SUPPORTS. End of answer.
Claim: {input}
'''


reflect_cot_prompt = '''Task:  Answer the given question step-by-step. Determine if there is Observation that SUPPORTS or REFUTES a Claim, or if there is NOT ENOUGH INFO, and conclude with the phrase 'so the final answer is: [SUPPORTS or REFUTES or NOT ENOUGH INFO]. End of answer.
...
Answer:
Step 1: Who is Reg Watson? Reginald James Watson AM was an Australian television producer and screenwriter.
Reflection: The identity of Reg Watson is accurately identified as a television producer.

Step 2: When did Reginald James Watson AM die? Reginald James Watson AM died on 8 October 2019.
Reflection: This is an important fact and directly affects whether the claim is true. If Reg Watson has passed away, it is clear that he is not a current producer.

Step 3: So the final answer is: REFUTES.
Reflection: The claim is refuted because Reg Watson is no longer alive, making him not a "current" television producer.

So the final answer is: REFUTES. End of answer.

Claim: The Gadsden flag was named by Christopher Gadsden. 
Answer:
Step 1: What is the origin of the name of the Gadsden flag? The Gadsden flag is named after politician Christopher Gadsden.
Reflection: This is accurate. The flag was indeed named after Christopher Gadsden.

Step 2: Who named the Gadsden flag? There is no information on who named the Gadsden flag.
Reflection: This is an error. The Gadsden flag was named after Christopher Gadsden, as mentioned in Step 1. The claim is supported by the information already provided.

Step 3: So the final answer is: SUPPORTS.
Reflection: **Error**: The previous statement in Step 2 mistakenly claimed there was no information about the flag’s name. This was incorrect, as we already know the flag is named after Christopher Gadsden.

So the final answer is: SUPPORTS. End of answer.

Claim: Black Mirror is about society. 
Answer:
Step 1: What is the origin of the name of the Gadsden flag? The Gadsden flag is named after politician Christopher Gadsden.
Reflection: The name of the Gadsden flag is indeed tied to Christopher Gadsden, which aligns with the claim.

Step 2: Who named the Gadsden flag? There is no information on who named the Gadsden flag.
Reflection: This statement contradicts the first step. We already know the flag is named after Christopher Gadsden, so there is sufficient information about the name's origin.

Step 3: So the final answer is: SUPPORTS.
Reflection: The claim is supported because the Gadsden flag is indeed named after Christopher Gadsden.
